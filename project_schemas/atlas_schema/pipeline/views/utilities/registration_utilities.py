...
from utilities2015 import load_hdf, xy_pixel_distance_lossless, find_contour_points, consolidate
from metadata import (all_known_structures_sided, 
                      ...
                      REGISTRATION_SETTINGS_CSV, rescale_by_resampling,
                      section_thickness, section_range_lookup)
